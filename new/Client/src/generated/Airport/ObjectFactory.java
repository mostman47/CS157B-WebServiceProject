...
public class ObjectFactory {
    ...
    private final static QName _TableAirport_QNAME = new QName("", "TableAirport");
    ...
    /**
     * Create an instance of {@link TableAirport }
     *
     */
    public TableAirport createTableAirport() {
        return new TableAirport();
    }
    ...
    public JAXBElement<Airport> createAirport(Airport value) {
     ...
     @XmlElementDecl(namespace = "", name = "TableAirport")
    public JAXBElement<TableAirport> createTableAirport(TableAirport value) {
        return new JAXBElement<TableAirport>(_TableAirport_QNAME, TableAirport.class, null, value);
    }
}